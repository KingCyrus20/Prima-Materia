...
object PrimaItems {
    val GENERAL_GROUP = FabricItemGroupBuilder.create(PrimaIdentifier("general"))
        .build()
    val TOOL_GROUP = FabricItemGroupBuilder.create(PrimaIdentifier("tool"))
        .icon { ItemStack(BowDrillItem) }
        .build()
    val EQUIPPABLE_GROUP = FabricItemGroupBuilder.create(PrimaIdentifier("equippable"))
