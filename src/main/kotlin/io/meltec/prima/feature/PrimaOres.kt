...
object PrimaOres {
    val ORE_COPPER_OVERWORLD = PrimaFeatures.PERLIN_ORE_CLUSTER
        .configure(PerlinOreClusterFeatureConfig(PrimaBlocks.COPPER_ORE.defaultState, 40, 24, 0.2))
        .decorate(Decorator.RANGE.configure(RangeDecoratorConfig(140, 0, 64)))
        .spreadHorizontally()
        .applyChance(300)

    val ORE_TIN_OVERWORLD = PrimaFeatures.PERLIN_ORE_CLUSTER
        .configure(PerlinOreClusterFeatureConfig(PrimaBlocks.TIN_ORE.defaultState, 48, 20, 0.3))
        .decorate(Decorator.RANGE.configure(RangeDecoratorConfig(140, 0, 64)))
        .spreadHorizontally()
        .applyChance(400)

    val ORE_ZINC_OVERWORLD = PrimaFeatures.PERLIN_ORE_CLUSTER
    ...
    fun register() {
        val oreCopperOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN, PrimaIdentifier("ore_copper_overworld"))
        ...
        val oreTinOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN, PrimaIdentifier("ore_tin_overworld"))
        ...
        val oreZincOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN, PrimaIdentifier("ore_zinc_overworld"))
